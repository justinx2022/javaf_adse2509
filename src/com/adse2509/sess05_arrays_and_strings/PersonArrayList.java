...
import com.adse2509.sess04_classes_object_and_methods.Person;
...
public class PersonArrayList
{
    ...
    public void displayPerson(ArrayList<Person> person)
    {
        ...
        System.out.printf("%-12s %-7s %-3sn", "Name", "Gender", "Age");
        ...
        System.out.println("The number of persons in the list is: " + person.size());
    }
    public static void main(String[] args)
    {
        ...
        System.out.println("After adding 'Arya' and removing 'Claire' we get...");
        pl.displayPerson(psn);
